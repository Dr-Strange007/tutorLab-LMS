...
export default function CheckOut() {
  ...
  const sslCmmerzHandle = async () => {
    try {
      const paymentSslCmmrzResponse = await sslCmmrPaymentApi();

      console.log('paymentSslCmmrzResponse',paymentSslCmmrzResponse)
